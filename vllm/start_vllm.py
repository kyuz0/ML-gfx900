...
def configure_and_launch(model_idx, gpu_count):
    ...
    while True:
        ...
        menu_args = [
            "--clear", "--backtitle", f"MI25 vLLM Launcher (GPUs: {gpu_count} detected)",
    ...
    # Env Vars
    env = os.environ.copy()
    # TRITON is essential for MI25 to avoid standard SDP memory/performance issues
...
def main():
    ...
    while True:
        ...
        choice = run_dialog([
            "--clear", "--backtitle", f"MI25 vLLM Launcher (GPUs: {gpu_count})",
            "--title", "Select Model",
