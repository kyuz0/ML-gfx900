...
refresh_toolbox() {
    ...
    local TOOLBOX_NAME="llama-gfx900-rocm${ROCM_VERSION//./-}"
    local IMAGE="docker.io/kyuz0/llamacpp-toolbox-gfx900:rocm-${ROCM_VERSION}"
...
show_menu() {
    ...
    echo "1) ROCm 6.4.4 (docker.io/kyuz0/llamacpp-toolbox-gfx900:rocm-6.4.4)"
    echo "2) ROCm 7.2.1 (docker.io/kyuz0/llamacpp-toolbox-gfx900:rocm-7.2.1)"
    echo "3) All (Both)"
    echo "4) Cancel"
